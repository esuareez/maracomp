...
export default async function CreateStore() {
    ...
    const {data : components } = await axios.get('https://api-maracomp-production-864a.up.railway.app/component');
    ...
    const handleSubmit = async (e : any) => {
        ...
        const res = await axios.post(`https://api-maracomp-production-864a.up.railway.app/store/${component.value}`, data)
        console.log(res)
    }
  ...
  return (
    <Popup
        trigger={
        <button className='h-3/6 w-11/12 text-white bg-verde hover:bg-verdeOscuro rounded-[10px]'>Agregar Almacén</button>
        }
        modal
        nested
    >
        ...
        <form method='POST' onSubmit={handleSubmit}>
            ...
            <div className='border-b border-gray-900/10 pb-12'>
                ...
                <p className='mt-1 text-sm leading-6 text-gray-600'>Agrega el componente a un nuevo almacén.</p>
